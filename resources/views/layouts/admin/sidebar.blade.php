    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
               ...
               <li class="nav-item dropdown {{ in_array($title, ['Rekap Absensi', 'Data Absensi']) ? 'active' : '' }}">
                    <a class="nav-link dropdown-toggle {{ in_array($title, ['Rekap Absensi', 'Data Absensi']) ? 'active' : '' }}" href="#" id="navbar-absen" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="false">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item {{ $title == 'Rekap Absensi' ? 'active' : '' }}" href="{{ url('/siswa') }}">
                            <span>Rekap Absensi</span>
                        </a>
                        <a class="dropdown-item" href="{{ route('weekly.attendance') }}">
                            Absensi Mingguan
                        </a>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link {{ $title == 'Tambah Data Siswa' ? 'active' : '' }}" href="/siswa/create">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
